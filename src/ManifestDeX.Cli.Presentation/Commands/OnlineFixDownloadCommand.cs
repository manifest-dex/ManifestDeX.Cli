...
public sealed class OnlineFixDownloadCommand : AsyncCommand<OnlineFixDownloadCommand.Settings>
{
    private readonly GetOnlineFixDownloadLinkUseCase _useCase;

    public OnlineFixDownloadCommand(GetOnlineFixDownloadLinkUseCase useCase)
    {
        _useCase = useCase;
    }
